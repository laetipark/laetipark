    ...
    <div>
      ...
      <div>
        ...
        <div className={'projects'}>
          ...
          <div className={'contents'}>
            ...
            <p>
              • <span className={'mark'}>언어 및 런타임 환경</span> :
            ...
            <p>
              • <span className={'mark'}>클라우드 서비스</span> :
              <span style={{ display: 'flex', gap: '4px' }}>
                <img
                  src={
            ...
            <p>
              • <span className={'mark'}>데이터베이스</span> :
              <span style={{ display: 'flex', gap: '4px' }}>
                <img
                  src={
      ...
      <div>
        ...
        <p className={'two-columns'}>
          ...
          <span className={'mark'}>프로젝트를 확장하여</span>
          <span>더 많은 데이터를 수집하고 다른 사람들도</span>
          <span>이용할 수 있는</span>
          <span className={'mark'}>전적 사이트 프로젝트</span>
          <span>입니다!</span>
        </p>
        <p className={'two-columns'}>
          <span style={{ fontWeight: 800 }}>• 프로젝트 링크 :</span>
          <a
            href={'https://blossomstats.site/'}
